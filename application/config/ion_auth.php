 ...
 */
$config['site_title']                 = "BukuLapak";       // Site Title, example.com
$config['admin_email']                = "admin@bukusekolahku.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['sales_group']                = 'seller';             // Default administrators group, use name
$config['agen_group']                 = 'agen';             // Default administrators group, use name
$config['admin_area_group']           = 'admin_area';             // Default administrators group, use name
...
$config['sending_email']           	  = FALSE;               // Sending email
/*
 | -------------------------------------------------------------------------
 | Cookie options.
 | -------------------------------------------------------------------------
