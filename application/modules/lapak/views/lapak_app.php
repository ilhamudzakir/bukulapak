              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <?php if($active == 'active') {?>
                    <button type="button" id="not_active" class="btn btn-danger" onClick="notactivated(<?php echo $this->uri->segment(3)?>,'<?php echo $judul_lapak?>')"><i class="fa fa-close"></i> Non aktifkan</button>
                  <?php }elseif($active == 'not active') { ?>
                    <button type="button" id="activated_id" class="btn btn-danger" onClick="activated_action(<?php echo $this->uri->segment(3)?>,'<?php echo $judul_lapak?>')"><i class="fa fa-close"></i> Aktifkan</button>
                  <?php } ?>
                </div>
              </div>
            </div>
