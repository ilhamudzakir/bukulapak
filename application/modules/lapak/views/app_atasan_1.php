                ...
                <div class="col-md-6 text-right">
                  <div class="col-md-4">
                    <?php if($valueis_approve_superior == 'approve') { 
                      ...
                      $checkednotapp = '';
                      $checkedpending = '';
                    }elseif($valueis_approve_superior == 'notapprove'){
                      $checkedapp = '';
                      $checkednotapp = 'checked="checked"';
                      $checkedpending = '';
                    }else{
                      $checkedapp = '';
                      $checkednotapp = '';
                      $checkedpending = 'checked="checked"';
                    }
                    ?>
                    <label><input id="yes" type="radio" value="pending" name="optionyes"<?php echo $checkedpending?>>
                    Pending <i class="fa fa-hourglass-2"></i></label>
                  </div>
                  <div class="col-md-4">
                    <label><input id="yes" type="radio" value="approve" name="optionyes" <?php echo $checkedapp?>>
                    Approve <i class="fa fa-thumbs-o-up"></i></label>
                  </div>
                  <div class="col-md-4">
                    <label><input id="no" type="radio" value="notapprove" name="optionyes" <?php echo $checkednotapp?>>
                    NotApprove <i class="fa fa-thumbs-o-down"></i></label>
                  </div>
                </div>
                <div class="col-md-6">
                  <button type="submit" class="btn btn-info">Submit</button>
                  <a href="<?php echo site_url('lapak/approve_atasan_1')?>">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <h4><?php echo strtoupper($valueis_approve_superior).' '.$icon; ?></h4>
                  <select id="superior_id" name="superior_id" style="width: 100%" disabled="disabled">
                ...
                <div class="col-md-6">
                  ...
                  <?php if($valueis_approve_next_superior == "approve") {
                    $icon = '<i class="fa fa-thumbs-o-up"></i>';
                  }elseif($valueis_approve_next_superior == "notapprove"){
                    $icon = '<i class="fa fa-thumbs-o-down"></i>';
                  }else{
                    $icon = '<i class="fa fa-hourglass-2"></i>';
                  }?>
                  <h4><?php echo strtoupper($valueis_approve_next_superior).' '.$icon; ?></h4>
                  <select id="next_superior_id" name="next_superior_id" style="width: 100%" disabled="disabled">
