                                                       ...
                                                       <div class="col-md-12">
                                                            <div class="row">
                                                                 <div class="col-md-10 padding-none">
                                                                      <input type="text" class="form school schoolin" name="sekolah" placeholder="Tuliskan Kode Lapak">
                                                                 </div>
                                                                 <div class="col-md-2 padding-none">
                                                                      <button type="submit" name="submit" class="form btn1"><span id="search">Cari</span></button>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                  </div>
