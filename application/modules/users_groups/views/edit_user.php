                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                        <div class="alert alert-info">
                            ...
                            <ol>
                                ...
                                <li>Kosongkan kolom password jika tidak ada perubahan password</li>
                                <li>Tekan tombol generate password sebelum melakukan penyimpanan jika ingin merubah password</li>
                            </ol>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                       ...
                                       <p>
                                        ...
                                        <p><?php echo bs_form_submit('submit', lang('edit_user_submit_btn')).'&nbsp;&nbsp;'.anchor("users_groups/sales_area", 'Cancel', array('class'=>'btn btn-danger'));?></p>
                                </div>
                            </div>
                        <?php echo form_close();?>
                </div>
