    ...
    <div class="martop grey">
      <form>
        ...
        <div class="form-group">
          ...
          <table width="100%">
            <tr>
              <td width="30%"><img src="assets/front/images/book.jpg" width="60" /></td>
              <td width="20%"><span class="grey">Judul Buku</span></br><h3 class="grey">45.000</h3></td>
          ...
          <div class="col-md-6 center">
            <button type="submit" name="submit" class="form btn2 large">Simpan Perubahan</button>
          </div>
          </div></div>
      </form>
    </div>
