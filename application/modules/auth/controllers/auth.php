...
class Auth extends MX_Controller {
    ...
    function index()
    {
        ...
        elseif ($this->ion_auth->is_admin())
        {
            ...
            $this->_render_page('auth/users_view', $this->data);   
        ...
        {   
            redirect('lapak','refresh');
            //return show_error('Here ; '.$this->ion_auth->is_admin().'You must be an administrator to view this page.');
        }
    }
    ...
    function _render_page($view, $data=null, $render=false)
    {
        ...
        if ( ! $render)
        {
           ...
           /* if ( ! in_array($view, array('auth/index')))
            ...
            /*if(in_array($view, array('auth/testpage')))
            {
                
                $this->template->add_js('testpage.js');
            }*/
