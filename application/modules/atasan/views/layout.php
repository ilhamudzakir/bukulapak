...
<header class="white">
	<div class="container">
     <div class="col-md-8 pull-left" style="padding-top:15px;"><img src="assets/front/images/logo.png"></div>
     <div class="col-md-4 pull-right text-right" style="padding-top:10px">
         <h3>Welcome Ahmad Yaya</h3>
     </div>   
    </div>
</header>
    ...
    <footer <?php if(!$this->uri->segment(2) and $this->uri->segment(1)=='atasan'){ ?> class="foot-bottom" <?php } ?> >
    <div class="container">
