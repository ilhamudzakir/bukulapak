            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <?php } ?>
                  <select id="kabupaten_id" name="kabupaten_id" style="width: 100%" onChange="getsekolah()">
                ...
                <div class="col-md-3">
                  ...
                  <select id="sekolah_id" name="sekolah_id" style="width: 100%">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-md-4">
                  ...
                  <?php } ?>
                  <select id="agen_id" name="agen_id" style="width: 100%">
