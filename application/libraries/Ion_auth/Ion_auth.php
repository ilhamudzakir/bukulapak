...
class Ion_auth
{
     ...
     * @author Andi Galuh
     **/
    public function is_sales($id=false)
    {
        $this->ion_auth_model->trigger_events('is_sales');

        $sales_group = $this->config->item('sales_group', 'ion_auth');

        return $this->in_group($sales_group, $id);
    }
     ...
     * @author Andi Galuh
     **/
    public function is_agen($id=false)
    {
        $this->ion_auth_model->trigger_events('is_agen');

        $agen_group = $this->config->item('agen_group', 'ion_auth');

        return $this->in_group($agen_group, $id);
    }
     ...
     * @author Andi Galuh
     **/
    public function is_admin_area($id=false)
    {
        $this->ion_auth_model->trigger_events('is_admin_area');

        $admin_area_group = $this->config->item('admin_area_group', 'ion_auth');

        return $this->in_group($admin_area_group, $id);
    }
