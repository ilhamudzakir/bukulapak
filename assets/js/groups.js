var save_method; //for save method string
          ...
          function add_groups()
          {
            ...
            $('.modal-title').text('Add groups'); // Set Title to Bootstrap modal title
          }
          ...
          function edit_groups(id)
          {
            ...
            $.ajax({
              ...
              success: function(data)
              {
                  ...
                  $('.modal-title').text('Edit groups'); // Set title to Bootstrap modal title
          ...
          function delete_groups(id)
          {
            ...
            if(confirm('Are you sure delete this data?'))
            {
              // ajax delete data to database
                $.ajax({
                  //url : "<?php echo site_url('groups/ajax_delete')?>/"+id,
